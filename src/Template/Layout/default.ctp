...
<body>
        ...
        <div class="sub-nav">
          <div class="site-container">
            ...
            <ul class="right">
              <li><?= $this->Html->link('+ Add Recipe', ['controller' => 'Recipes', 'action' => 'add']); ?></li>
            </ul>
          </div>
        </div>
      ...
      <div class="site-container">
          <div class="container">
            <div class="content">
              ...
              <svg width="200px"  viewBox="0 0 381 85.9" style="enable-background:new 0 0 381 85.9" xml:space="preserve">
                  <g>
          ...
          <div class="subtext">
            <p>© 2017 <a href="http://matthewlean.co.uk">Matthew Lean</a></p>
          </div>
    </footer>
</body>
</html>
