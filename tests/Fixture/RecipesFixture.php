...
class RecipesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'steps' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-03-22 10:31:50',
            'modified' => '2017-03-22 10:31:50',
            'steps' => 1
        ],
    ];
}
