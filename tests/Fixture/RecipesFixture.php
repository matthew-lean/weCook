...
class RecipesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'steps_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-03-22 11:03:05',
            'modified' => '2017-03-22 11:03:05',
            'steps_id' => 1
        ],
    ];
}
