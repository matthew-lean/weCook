...
class RecipesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'steps_description' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-03-22 12:00:20',
            'modified' => '2017-03-22 12:00:20',
            'steps_description' => 1
        ],
    ];
}
